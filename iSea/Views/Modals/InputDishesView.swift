...
struct InputDishesView: View {
    ...
    var body: some View {
        NavigationStack {
            Text("How much time did you spend doing the dishes today?").bold().font(.largeTitle).multilineTextAlignment(.center)
                .padding()
